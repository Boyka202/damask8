...
class Config:
    ...
    PARAM_SPACE = [
        Real(name='tau_0', low=20e6, high=40e6, prior='log-uniform'),  # Adjusted for initial yield matching exp
        ...
        # CRITICAL ADDITION: Allow optimizer to control initial mobile dislocation density
        Real(name='rho_mob_0', low=1.0e9, high=5.0e11, prior='log-uniform'), # Wide range, especially lower end
        
        Real(name='rho_dip_0', low=5.0e10, high=5.0e11, prior='log-uniform'), 
        Real(name='B', low=0.001, high=0.05, prior='log-uniform'), 
        
        # CRITICAL REDUCTION: Scale down hardening magnitude
